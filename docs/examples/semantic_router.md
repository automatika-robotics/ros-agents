...
text_in_llm = Topic(name="text_in_llm", msg_type="String")
text_out = Topic(name="text_out_llm", msg_type="String")

llm = LLM(
    inputs=[text_in_llm],
    outputs=[text_out_llm],
    model_client=ollama_client,
    trigger=[text_in_llm],
)

# Make a Go-to-X component using the same Llama3_1 model
text_in_goto = Topic(name="text_in_goto", msg_type="String")
...
goto_route = Route(routes_to=text_in_goto,
...
llm_route = Route(routes_to=text_in_llm,
