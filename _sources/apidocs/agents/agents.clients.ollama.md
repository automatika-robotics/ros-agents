...
````{py:class} OllamaClient(model: agents.models.LLM, host: str = '127.0.0.1', port: int = 11434, inference_timeout: int = 30, init_on_activation: bool = True, logging_level: str = 'info')
