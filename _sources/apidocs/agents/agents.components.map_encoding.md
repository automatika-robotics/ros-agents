...
`````{py:class} MapEncoding(*, layers: list[agents.ros.MapLayer], position: agents.ros.Topic, map_topic: agents.ros.Topic, config: agents.config.MapConfig, db_client: agents.clients.db_base.DBClient, trigger: typing.Union[agents.ros.Topic, list[agents.ros.Topic], float] = 10.0, callback_group=None, component_name='map_encoder_component', **kwargs)
...
````{py:method} add_point(layer: agents.ros.MapLayer, point: tuple[numpy.ndarray, str]) -> None
