...
````{py:class} VideoMessageMaker(*, inputs: typing.List[agents.ros.Topic], outputs: typing.List[agents.ros.Topic], config: typing.Optional[agents.config.VideoMessageMakerConfig] = None, trigger: typing.Union[agents.ros.Topic, typing.List[agents.ros.Topic]], callback_group=None, component_name: str = 'video_maker_component', **kwargs)
