...
````{py:class} SemanticRouter(*, inputs: typing.List[agents.ros.Topic], routes: typing.List[agents.ros.Route], config: agents.config.SemanticRouterConfig, db_client: agents.clients.db_base.DBClient, default_route: typing.Optional[agents.ros.Route] = None, callback_group=None, component_name: str = 'router_component', **kwargs)
